...
public class CardView extends StackPane {
    ...
    public void show() {
        ...
        this.getChildren().addAll(background, topL, mid, botR);
    ...
    public void hideDetails() {
        ...
        this.setVisible(true);
        this.getChildren().clear();
        background = new ImageView(backIm);
        background.setFitHeight(CARD_HEIGHT * 0.7);
        background.setFitWidth(CARD_WIDTH * 0.7);
